...
public class Tester {
    ...
    */
    private Test generateTest(int id) {
        ...
        generatedTest.setLando((long) (Math.random() * (200) + 100));
        generatedTest.setR2D2((long) (Math.random() * (200) + 100));
    ...
    public void runTestsFromFile() {
        ...
        try {
            ...
            for (int i = 0; i < currentTests.length; i++) {
                ...
                Main.main(new String[]{"input.json","output.json"});
                do {
                    Thread.sleep(10);
                ...
                boolean passedSecondTest = true; //Checking Num Of Attacks Logic
                ...
                if (shieldDeactivationTestValue-currentTests[i].getR2D2Sleep() <0 || shieldDeactivationTestValue-currentTests[i].getR2D2Sleep() >= 20)
                ...
                if (soloTerminate - minTerminate > 0000000000010L || C3POTerminate - minTerminate > 0000000000010L
                        || LandoTermiante - minTerminate > 0000000000010L || R2D2Terminate - minTerminate > 0000000000010L)
...
//                MessageBus ins1 = MessageBusImpl.getInstance();
//                ins1.resetMessageBus();
//                Ewoks ins2 = Ewoks.GetEwoksInstance();
//                ins2.resetEwoks();
            }
            System.out.println("\r\n-----------------");
    ...
    */
    ...
    public void runLogicalTests() {
        try {
            ...
            MessageBus messageInstance = MessageBusImpl.getInstance();

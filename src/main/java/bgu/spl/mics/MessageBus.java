...
public interface MessageBus {
     ...
     */
    <T> void subscribeEvent(Class<? extends Event<T>> type, MicroService m) throws Exception;
     ...
     * @param m    	The subscribing micro-service.
     */
    void subscribeBroadcast(Class<? extends Broadcast> type, MicroService m) throws Exception;
     ...
     *                              to became available.
     */
    Message awaitMessage(MicroService m) throws Exception;
